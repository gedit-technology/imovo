...
pushd "${imovo_config_git_repos_orig_location}/gspell" || exit 1
...
mv "gspell-${version}.tar.xz" "${imovo_config_new_tarballs_location}/" || exit 1
...
echo "Tarball pathname: ${imovo_config_new_tarballs_location}/gspell-${version}.tar.xz"
