...
pushd "${imovo_config_git_repos_orig_location}/gnome-latex" || exit 1
...
mv "gnome-latex-${version}.tar.xz" "${imovo_config_new_tarballs_location}/" || exit 1
...
echo "Tarball pathname: ${imovo_config_new_tarballs_location}/gnome-latex-${version}.tar.xz"
